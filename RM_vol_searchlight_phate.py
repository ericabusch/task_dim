...
def phate_kernel(data, sl_mask, myrad, bcvar):
    data=data[0]
    ...
    op = phate.PHATE(verbose=0, n_jobs=-1).fit(data_arr)
...
if __name__ == "__main__":
    ...
    print(sub_id, task, sl_rad, 'phate')
    ...
    all_sl_result = sl.run_searchlight(phate_kernel, pool_size=pool_size)
    ...
    if rank == 0: 
        ...
        for i, nm, cmap in zip([0], ['phate_optt'], ['viridis']):
