...
if __name__ == "__main__":
    ...
    if task == 'localizer': 
        ...
        run = 8
    results_path = f'./StudyForrest/results/sub-{sub_id:02d}_{task}'
    outfn = f'{results_path}_optimal_t_whole_brain_SL_rad{sl_rad}.nii.gz'
    ...
    if rank == 0:
        data_i, wb_mask, affine_mat, dimsize = load_data(sub_id, task, run)
        data.append(data_i)
    ...
    if rank == 0: 
        ...
        for i, nm in zip([0,1], ['optimal_t','autocorrelation']):
