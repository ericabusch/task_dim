...
def run_sl_full(idx, searchlight, hemi):
    ...
    clf_acc1, clf_p1 = sva.clf_wrapper(searchlight_data, labels[:,0], n_folds=N_FOLDS, num_reps=N_REPS, balance=True)
    clf_acc2, clf_p2 = sva.clf_wrapper(searchlight_data, labels[:,1], n_folds=N_FOLDS, num_reps=N_REPS, balance=True)
    clf_acc3, clf_p3 = sva.clf_wrapper(searchlight_data, labels[:,2], n_folds=N_FOLDS, num_reps=N_REPS, balance=True)
